<template>
  <div v-if="personaje_info != null" tabindex="-1" aria-hidden="true" class="flex justify-center place-items-center overflow-y-auto overflow-x-hidden fixed w-full md:inset-0 md:h-full">
